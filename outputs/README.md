...
A dependency-free unlimited calculation and banking-exam quantitative aptitude quiz app.

## Run

Open `index.html` directly in a modern browser, or serve this folder with any static file server.
...
- Results with score, time, shortcut methods, and answer explanations
- Local quiz history and practice statistics
